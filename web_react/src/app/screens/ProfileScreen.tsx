...
export function ProfileScreen({ onNavigate, isDarkMode = false, onToggleDarkMode }: ProfileScreenProps) {
  const menuItems = [
    ...
    <div className="min-h-screen pb-24 bg-background">
      ...
      <div className="bg-gradient-to-br from-primary to-secondary px-4 pt-12 pb-8">
        <div className="flex items-center gap-4 mb-6">
          <div className="w-20 h-20 rounded-full bg-white flex items-center justify-center text-2xl shadow-lg">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-white/80">Chưa đăng nhập</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 -mt-6 space-y-6">
        ...
        <div className="bg-card rounded-2xl p-6 shadow-lg border border-border text-center">
          ...
          <button className="w-full py-3 bg-primary text-white rounded-xl font-medium hover:opacity-90 transition-opacity">
            Đăng nhập / Đăng ký
          </button>
        </div>
